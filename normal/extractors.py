...
# for better facebook protection handling
from requests_html import HTML as rHTML
        ...
        try:
            ...
            try:
                ...
                if WD is None:
                    ...
                    options.add_argument("--lang=en-US") # force english chrome
                ...
                css_sel = WD.find_elements_by_css_selector(".story_body_container") or WD.find_elements_by_css_selector("#MPhotoContent") or None
                element = rHTML(html=css_sel[0].get_attribute("outerHTML"), url=FB_MOBILE_BASE_URL)
